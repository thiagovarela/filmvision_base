defmodule Filmvision.AccountsTest do
  use Filmvision.DataCase

  alias Filmvision.Accounts

  import Filmvision.AccountsFixtures
  alias Filmvision.Accounts.{User, UserToken}
  ...
  describe "get_user!/1" do
    test "raises if id is invalid" do
      assert_raise Ecto.NoResultsError, fn ->
        ...
        Accounts.get_user!("01234567-89ab-cdef-0123-456789abcdef")
      end
    end
  ...
  describe "register_user/1" do
    ...
    test "registers users without password and creates default organization and project" do
      ...
      expected_org_name = extract_username_from_email(email) <> "'s Organization"
      assert organization.name == expected_org_name

      # Verify user is owner of the organization
      assert Accounts.get_user_role_in_organization(user, organization) == "owner"
      ...
      assert Projects.get_user_role_in_project(user, project) == "owner"
    end
